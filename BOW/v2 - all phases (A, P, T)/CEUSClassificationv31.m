...
for lesionType = 1:5
    for patient = 1:patientsPerLesion(lesionType)
        ...
        disp(num2str((lesionType-1)*patientsPerLesion(lesionType)+patient))
...
accuracy = right*100/((lesionType-1)*patientsPerLesion(lesionType)+patient)
